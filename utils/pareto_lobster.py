...
elitePools = { "forwardOnly":'scripts/trainLobster_ForwardOnly/output/2023-02-01_23-44-35/',
              "forwardMinEnergy":'scripts/trainLobster_ForwardMinEnergy/output/2023-02-02_19-22-39/'}
...
plt.title("pareto score vs iterations for Lobster with different objectives")
plt.savefig("trainLobster_energyefficiency.png")
