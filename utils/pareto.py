...
# elitePools = [
#               'scripts/trainTable_16/output/2023-02-23_19-02-40/', 'scripts/trainTable_32/output/2023-02-26_19-39-41/',
#              'scripts/trainTable_64/output/2023-02-26_19-51-44/', 
#              ]
...
plt.title("pareto score vs iterations for Table with 64 channels")
plt.savefig("trainTable_64_iterations.png")
