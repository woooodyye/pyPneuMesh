...
plt.ylabel("pareto score for Moving Forward")
plt.title("pareto score vs iterations for Table with multiple channels")
plt.savefig("trainTable_alliterations_movingForward.png")
