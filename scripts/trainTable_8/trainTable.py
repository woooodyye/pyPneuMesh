...
dict = readMooDict('scripts/trainTable_8/data')
...
if mode == "start":
    GASetting = {
        ...
        'folderDir': 'scripts/trainTable_8/',
    ...
    mooDict = readMooDict('./scripts/trainTable_8/data')
    ...
    moo.saveAll('scripts/trainTable_8/data', 'table')
