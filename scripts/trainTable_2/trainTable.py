...
dict = readMooDict('scripts/trainTable_2/data')
...
if mode == "start":
    GASetting = {
        ...
        'folderDir': 'scripts/trainTable_2/',
    ...
    mooDict = readMooDict('./scripts/trainTable_2/data')
    ...
    moo.saveAll('scripts/trainTable_2/data', 'table')
